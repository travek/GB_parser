...
def export_messages_to_file(messages):    
    ...
    with open(f'.\\Export\\messages-{today_str}.txt', 'w', encoding='utf-8') as file:  
        ...
        file.write("Какие общие макроэкономические темы обсуждались ? Какие тренды они могут формировать или изменять? \n")
        file.write("Какие торговые рекомендации были даны или сформулированы в чате?\n")        
        file.write("Какие эмитенты обсуждались ?\n")
        file.write("Какие эмитенты, если такие были, были позитивно оценены и почему?\n")
        file.write("Какие эмитенты, если такие были, были негативно оценены и почему?\n")
